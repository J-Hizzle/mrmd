...
struct Config
{
    ...
    std::string fileOut = "influxBoundary";  ///< base name for output files
...
int main(int argc, char* argv[])  // NOLINT
{
    ...
    app.add_option(
        "--innermin", config.intRegionMin, "inner interacting region minimum coordinate");
    app.add_option(
        "--innermax", config.intRegionMax, "inner interacting region maximum coordinate");
    app.add_option(
