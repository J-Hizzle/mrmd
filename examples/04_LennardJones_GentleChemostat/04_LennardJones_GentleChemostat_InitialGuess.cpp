...
struct Config
{
    ...
    std::string fileOut = "gentleChemostat_initialGuess";  ///< base name for output files
...
void gentleChemostat_initialGuess(Config& config)
{
    // initialize
...
int main(int argc, char* argv[])
{
    ...
    gentleChemostat_initialGuess(config);
